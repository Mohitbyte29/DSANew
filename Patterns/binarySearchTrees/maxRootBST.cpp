...
private:
    ...
    NodeValue helper(TreeNode* root) {
        ...
        if (left.maxNode < root->val && right.minNode > root->val) {
            int sum = left.maxSize + right.maxSize;
            return NodeValue(
